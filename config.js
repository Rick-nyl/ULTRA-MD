...
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || '255628574806';  // put your number here
...
global.pairingNumber = process.env.BOT_NUMBER || '255628574806';  // put your number here
global.SESSION_ID = process.env.SESSION_ID || 'qBYhGbaQ#uJcFoGkDmMelsEcifsNNX3pbqXcDj1dUtV7F8i1m-IM';  // put your session id here
